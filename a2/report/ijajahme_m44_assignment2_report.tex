...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{grid_training.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{eps_grid.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{lunar_training.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{eps_lunar.png}
    \end{center}
...
The simple \verb|FeedForward| neural network approach has successfully learned the optimal policy for all three environments. The evaluation result for the GridEnvironment is somewhat inconsistent because the agent is placed at a random starting square, which affects the number of steps required to reach the goal. To encourage the agent to reach the goal as quickly as possible, we applied a negative reward of $-0.1$ for each step taken.
